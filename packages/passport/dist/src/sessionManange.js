...
var SessionManager = /** @class */ (function () {
    ...
    SessionManager.prototype.getSession = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, localforage.getItem(SESSION_KEY)];
    ...
    SessionManager.prototype.getUser = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, localforage.getItem(USER_KEY)];
                    case 1:
                        user = _a.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, localforage.setItem(SESSION_KEY, session)];
                    case 1:
                        _a = (_b.sent());
                        if (!_a) return [3 /*break*/, 3];
                        return [4 /*yield*/, localforage.setItem(USER_KEY, user)];
                    case 2:
                        _a = (_b.sent());
                        _b.label = 3;
...
//# sourceMappingURL=sessionManange.js.map